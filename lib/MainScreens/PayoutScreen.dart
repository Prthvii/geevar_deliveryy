...
import 'package:spicy_food_delivery/api/payoutReqApi.dart';
import 'package:spicy_food_delivery/api/statusUpdationApi.dart';
import 'package:spicy_food_delivery/api/storeEarningListApi.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CupertinoSwitch(
              value: arrStoreDetails!=null?arrStoreDetails["isAvailable"]:false,
            ...
            Text(
              arrStoreDetails!=null?arrStoreDetails["isAvailable"]==true?"Online":"Offline":"",
