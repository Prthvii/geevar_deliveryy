...
import 'package:spicy_food_delivery/OrderFragment/orderDetails.dart';
import 'package:spicy_food_delivery/Utils/Const.dart';
import 'package:spicy_food_delivery/api/orderListingApi.dart';
    ...
    return GestureDetector(
      onTap: () async {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => OrderDetailsPg(
                    id: item['id'],
                  )),
        );
